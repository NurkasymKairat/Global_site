...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function req(e) {
    ...
    getResource('http://localhost:3000/people', obj).then(data => console.log(data));
  ...
  function addListMu(selector, id) {
    ...
    blockId.addEventListener('click', e => {
      e.preventDefault();
      Object(_query__WEBPACK_IMPORTED_MODULE_0__["default"])(id);
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (scrollByJq);
...
const scrollFunc = () => {
  ...
  window.addEventListener('scroll', () => {
    ...
    const scroll = undefined.scrollTop();
...
/* harmony default export */ __webpack_exports__["default"] = (scrollFunc);
